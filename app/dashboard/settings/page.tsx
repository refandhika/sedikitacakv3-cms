...
import { CreateSetting } from "@/app/ui/settings/buttons";
        ...
        <main>
            ...
            <div className="w-full">
                <div className="mt-4 flex items-center justify-between gap-2 md:mt-8">
                    <Search placeholder="Search setting..." />
                    <CreateSetting />
                </div>
                <Suspense key={query + currPage} fallback={<InvoicesTableSkeleton />}>
                    <SettingsTable query={query} currentPage={currPage} currentLimit={currLimit} />
                </Suspense>
