import TechsTable from "@/app/ui/techs/table";
import { CreateTech } from "@/app/ui/techs/buttons";
        ...
        <main>
            ...
            <div className="w-full">
                ...
                <Suspense key={query + currPage} fallback={<InvoicesTableSkeleton />}>
                    <TechsTable query={query} currentPage={currPage} currentLimit={currLimit} />
                </Suspense>
